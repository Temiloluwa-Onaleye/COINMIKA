...
function SecondBody({purpleBg, darkText, darkTextDesc, headline, description, buttonLabel, img, alt, imgStart}) {
  return(
<>
...
<div className='body__hero-text-wrapper'>
    ...
    <Link to='/'>
    <Button buttonSize='btn--medium' buttonColor='purple'>
        {buttonLabel}
    </Button>
    </Link>
...
<img src={img} alt={alt} className='body__hero-img secondImg' />
</div>
</div>
    </div>
</div>
